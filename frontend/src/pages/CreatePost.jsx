        ...
        <div>
            ...
            <div className='px-6 md:px-[200px] mt-8'>
                ...
                <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
                    ...
                    <textarea className='px-4 py-2 outline-none' placeholder='Enter post description' />
                    <button className='bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4 py-2 md:text-xl rounded-lg text-lg'>Create</button>
                </form>
